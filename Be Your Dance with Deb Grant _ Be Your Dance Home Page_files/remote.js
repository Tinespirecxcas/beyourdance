...
L:"ytp-mdx-manual-pairing-popup-dialog",U:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",Z:"A breve non sar\u00e0 pi\u00f9 possibile connettersi alla TV sul Web utilizzando un codice"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",R:[{G:"button",la:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],Z:"Ulteriori informazioni"},{G:"button",la:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],Z:"OK"}]}]}]});
this.u=new g.jO(this,250);this.learnMoreButton=this.ia("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.ia("ytp-mdx-manual-pairing-popup-ok");g.D(this,this.u);this.N(this.learnMoreButton,"click",this.B);this.N(this.okButton,"click",this.C)},P8=function(){g.V.call(this,{G:"div",
L:"ytp-mdx-popup-dialog",U:{role:"dialog"},R:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",R:[{G:"div",L:"ytp-mdx-popup-title",Z:"Disconnessione eseguita"},{G:"div",L:"ytp-mdx-popup-description",Z:"I video che guardi potrebbero essere aggiunti alla cronologia delle visualizzazioni della TV e influenzare i consigli sulla TV. Per evitare che ci\u00f2 avvenga, annulla l'operazione e accedi a YouTube dal tuo computer."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",R:[{G:"button",la:["ytp-button","ytp-mdx-privacy-popup-cancel"],
Z:"Annulla"},{G:"button",la:["ytp-button","ytp-mdx-privacy-popup-confirm"],Z:"Conferma"}]}]}]});this.u=new g.jO(this,250);this.cancelButton=this.ia("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.ia("ytp-mdx-privacy-popup-confirm");g.D(this,this.u);this.N(this.cancelButton,"click",this.B);this.N(this.confirmButton,"click",this.C)},Q8=function(a){g.V.call(this,{G:"div",
...
c=g.U(b,128)?g.KL("Errore su $RECEIVER_NAME",c):b.Gb()||g.U(b,4)?g.KL("In riproduzione su $RECEIVER_NAME",c):g.KL("Connesso a $RECEIVER_NAME",c);a.za("statustext",c);a.u.show()}else a.u.hide()},R8=function(a,b){g.vX.call(this,"Riproduci su",0,a,b);
...
this.Qh={key:i6(),name:"Questo computer"};this.Kg=null;this.subscriptions=[];this.Tz=this.yb=null;this.Dl=[this.Qh];this.Hk=this.Qh;this.Lc=new g.HM(64);this.oE=0;this.Fe=-1;this.po=null;this.xr=this.Fu=!1;this.Um=this.Ro=null;if(!g.KD(this.player.T())){a=this.player;var b=g.yT(a);b&&(b=b.Pk())&&(b=new R8(a,b),g.D(this,b));b=new Q8(a);g.D(this,b);g.xP(a,b.element,4);this.Ro=new P8;g.D(this,this.Ro);g.xP(a,this.Ro.element,4);g.Q(this.player.T().experiments,"pair_servlet_deprecation_warning_enabled")&&
...
R8.prototype.Uh=function(a){return"cast-selector-receiver"===a?"Trasmetti\u2026":this.Dl[a].name};
